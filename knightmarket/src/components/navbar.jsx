                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="mx-auto">
                        ...
                        <Nav.Link
                            as={Link}
                            to="/marketplace"
                            className={`d-flex align-items-center ${isActive('/marketplace') ? 'active fw-bold' : ''}`}
                        >
                        ...
                        <Nav.Link
                            as={Link}
                            to="/forum"
                            className={`d-flex align-items-center ${isActive('/forum') ? 'active fw-bold' : ''}`}
                        >
                        ...
                        <Nav.Link
                            as={Link}
                            to="/messages"
                            className={`d-flex align-items-center ${isActive('/messages') ? 'active fw-bold' : ''}`}
                        >
